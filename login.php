...
<body>
    ...
    <div class="main-cont ">
        ...
        <form class="form_container" method="post">
            <div class="logo_container"><img src="assets/img/logo.svg" class="logosvg"></div>
            ...
            <div class="input_container">
                <label class="input_label" for="email_field">Username <span style="color:red">*</span></label>
                ...
                <input placeholder="name@mail.com" title="Inpit title" type="text" name="username" autocomplete="off" required class="input_field" id="email_field">
            </div>
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" type="password" name="password" autocomplete="off" required class="input_field" id="password_field">
            </div>
